...
#if _MSC_VER >= 1400
	__forceinline s32 MULSHIFT_S32 (
		s32 Factor1,
		s32 Factor2,
		u8 Bits
					) {
...
#define MULSHIFT_S32( Factor1, Factor2, Bits )\
                        ( (int) (( (Sint64)(Factor1) * (Factor2) ) >> (Bits)) )
#endif
...
static ReverbParams reverb_params_Room = {
	0x26C0/2,
...
static ReverbParams reverb_params_StudioSmall = {
	0x1F40/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_StudioMedium = {
	0x4840/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_StudioLarge = {
	0x6FE0/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_Hall = {
	0xADE0/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_SpaceEcho = {
	0xF6C0/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_Echo = {
	0x18040/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_Delay = {
	0x18040/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams reverb_params_HalfEcho = {
	0x3C00/2,
//	gLPF		gEcho0		gEcho1		gEcho2		gEcho3		gWall
...
static ReverbParams * reverb_param_modes[] = {
	&reverb_params_Room,
...
void Reverb::process(int *p_input,int *p_output,int p_frames) {
...
#define LM_REVERB(x) reverb_buffer[ (x) + cSample ]
	...
	while ( p_frames ) {
		...
		for (int cSample=0;cSample<aSample;cSample++) {

			int tempL0, tempL1, tempR0, tempR1;

			tempL1 = p_input[(cSample)*2];
			tempR1 = p_input[(cSample)*2 + 1];
			...
			*/
			...
			Output
			*/
			p_output[(cSample)*2] += tempL0;
			p_output[(cSample)*2 + 1] += tempR0;
...
void Reverb::adjust_current_params() {
...
#define LM_CONFIG_PARAM( x )\
	current_params->x=(int)( ( (Sint64)current_params->x*(Sint64)mix_rate*8L)/(Sint64)44100);\
	...
	reverb_buffer = new int[needed_buffer_size];
...
void Reverb::set_mode(Mixer::ReverbMode p_mode) {
...
void Reverb::set_mix_rate(int p_mix_rate) {
...
Reverb::Reverb() { 
	...
	mode=Mixer::REVERB_MODE_ROOM;
	mix_rate=1;
	current_params = new ReverbParams;	
}
